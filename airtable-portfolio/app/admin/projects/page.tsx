  ...
  return (
    <div className="flex">
      ...
      {(isCreating || selectedProject) && (
        <Dialog
          open={isCreating || !!selectedProject}
          onOpenChange={() => {
            setIsCreating(false);
            setSelectedProject(null);
          }}
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                {isCreating ? "Remplis les infos du projet." : "Tu peux modifier les infos du projet."}
              </DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit(isCreating ? createProject : updateProject)} className="space-y-4">
              ...
              <DialogFooter className="pt-4">
                ...
                {!isCreating && selectedProject && (
                  <Button type="button" variant="destructive" onClick={() => deleteProject(selectedProject.id)}>
                    Supprimer
                  </Button>
                )}
              </DialogFooter>
